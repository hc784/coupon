...
import foodOrder.auth.enums.Authority;
import foodOrder.auth.jwt.JwtTokenProvider;
import foodOrder.auth.security.SecurityUtil;
import foodOrder.auth.v1.dto.Response;
import foodOrder.auth.v1.dto.request.UserRequestDto;
import foodOrder.auth.v1.dto.response.UserResponseDto;
...
System.out.println(tokenInfo.getAccessToken());
            ...
            log.error("로그인 실패: {} - {}", ex.getClass().getSimpleName(), ex.getMessage());
            return response.fail("이메일 또는 비밀번호가 올바르지 않습니다.",
